...
namespace Patsanstha.Modules.Collections.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260624092032_InitialCollections")]
            ...
            modelBuilder.Entity("Patsanstha.BuildingBlocks.Infrastructure.Persistence.Audit.AuditLogEntry", b =>
                {
                    ...
                    b.ToTable("audit_logs", "collections");
                });
            ...
            modelBuilder.Entity("Patsanstha.BuildingBlocks.Infrastructure.Persistence.Outbox.OutboxMessageEntity", b =>
                {
                    ...
                    b.ToTable("outbox_messages", "collections");
                });

            modelBuilder.Entity("Patsanstha.Modules.Collections.Domain.Entities.CollectionReceipt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("collection_receipts", "collections", t =>
                        {
                            t.HasCheckConstraint("ck_collections_amount_positive", "\"Amount\" > 0");

                            t.HasCheckConstraint("ck_collections_status", "\"Status\" IN ('Collected','Reversed')");
                        });
                });
